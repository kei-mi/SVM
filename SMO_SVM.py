...
class SMO_SVM:
  ...
  def plot_scatter(self):
    if self.dim == 2:
      ...
      plt.xlabel('X0')
      plt.ylabel('X1')
      plt.scatter(self.X[self.y==1,0], self.X[self.y==1,1], color="red", marker="+", label='1')
      plt.scatter(self.X[self.y==-1,0], self.X[self.y==-1,1], color="blue", marker="*", label='-1')
      ...
      ax.set_ylabel('X1')
      ax.set_zlabel('X2')
      ax.scatter(self.X[self.y==1,0], self.X[self.y==1,1], self.X[self.y==1,2], color="red", marker="+", label='1')
      ax.scatter(self.X[self.y==-1,0], self.X[self.y==-1,1], self.X[self.y==-1,2], color="blue", marker="*", label='-1')
